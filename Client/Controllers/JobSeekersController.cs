...
namespace Client.Controllers
{
    public class JobSeekersController : Controller
    {
        ...
        public JobSeekersController(ClientContext context)
        {
            client = new HttpClient();
            baseUrl = "http://jjin1112-eval-test.apigee.net/manyjobsproxy/api/JobSeekers/";
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var jobSeekers = await JobSeekerExists((int)id);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var jobSeeker = await JobSeekerExists((int)id);
            if (jobSeeker == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SeekerId,SeekerName,SeekerEmail,SeekerMajor,Skill,SeekerCity,SeekerCountry")] JobSeeker jobSeeker)
        {
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(baseUrl);
            client.DefaultRequestHeaders.Accept.Clear();
        ...
        private async Task <JobSeeker> JobSeekerExists(int id)
        {
            client.BaseAddress = new Uri(baseUrl);
            client.DefaultRequestHeaders.Accept.Clear();
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
