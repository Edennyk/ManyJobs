...
namespace Client.Controllers
{
    public class JobOffersController : Controller
    {
        ...
        public JobOffersController()
        {
            ...
            baseUrl = "http://jjin1112-eval-test.apigee.net/manyjobsproxy/api/JobOffers/";
       ...
       // GET: JobOffers/Details/5 : 
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var jobOffer = await JobOfferExists((int)id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobId,JobName,JobTitle,JobExperience,Skill,JobAddress,JobSalary")] JobOffer jobOffer)
        {
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(baseUrl);
            client.DefaultRequestHeaders.Accept.Clear();
        ...
        //get by id
        private async Task<JobOffer> JobOfferExists(int id)
        {
            client.BaseAddress = new Uri(baseUrl);
            client.DefaultRequestHeaders.Accept.Clear();
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
